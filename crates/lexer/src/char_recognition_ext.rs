...
/// Adds helpful functionality when considering how characters should be
/// interpreted as tokens.
pub(crate) trait CharRecognitionExt {
...
impl CharRecognitionExt for char {
    fn is_id_caboose(self) -> bool {
